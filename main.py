...
from telnet_server import run_telnet_server, handle_telnet_client
        ...
        while not check_shutdown_requested():
            ...
            try:
                run_telnet_server(
                    ...
                    wrap_text_func=wrap_text,
                    generate_initial_greeting_func=generate_initial_greeting,
                    generate_goodbye_func=generate_goodbye,
                    detect_quit_intent_func=detect_quit_intent,
                    StreamingTextWrapper_class=StreamingTextWrapper,
                    Colors_class=Colors
                )
